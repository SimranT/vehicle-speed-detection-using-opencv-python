                ...
                if [x1, y1, w1, h1] != [x2, y2, w2, h2]:
                    if (speed[i] == None or speed[i] == 0) and y1 >= 300:
                        ...
                        if speed[i] > SPEED:
                            ...
                            cv2.imwrite('vehicle\{}.png'.format(i), roi)
                        ...
                        cars_path = r'C:\xampp\htdocs\Major project\final project\vehicle'
...
model = load_model('for_last.h5', compile=False)
...
cars_path = r'C:\xampp\htdocs\Major project\final project\licenseplate'
for filename in os.listdir(cars_path):
    filename, _ = os.path.splitext(filename)
    filepath = filename + ".png"
